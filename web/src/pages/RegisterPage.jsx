...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-700 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <h1 className="text-3xl font-bold text-center mb-2">ReelUsta</h1>
          <p className="text-gray-600 text-center mb-8">Hesap Oluştur</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <label className="block text-gray-700 font-semibold mb-2">Şifre Doğrula</label>
              <input
                type="password"
